...
OR
python sts_train.py pretrained_transformer_model_name
"""
...
from sentence_transformers import SentenceTransformer, losses, SimilarityFunction, SentenceTransformerTrainingArguments, \
