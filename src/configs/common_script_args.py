...
class CommonScriptArguments:
    dataset: str | List[str] = field(
        ...
        metadata={"help": "The name on HF or path to jsonl file of the dataset to use. Can be a list of paths."},
    )
    dataset_ratio: float | None = field(
        default=None,
        metadata={"help": "How much of dataset should we take. Each ratio should be between 0 and 1"}
    )
